...
for metric in all_metrics:
    ...
    for s in range(num_seeds):
        ...
        for m in range(num_masters):
            ...
            filename = f'{folder_name}/MMBorg_4M_STARFIT_fewalter_nfe30000_seed{seed}_{m}.metric'
            ...
            if not os.path.exists(filename):
                ...
                hvol_matrix[m, :] = runtime_bs[metric].values
    ...
    plt.savefig(f'{metric}_{problem}.png')