...
if __name__ == "__main__":
    ...
    for reservoir_name in RESERVOIR_NAMES:
        ...
        for policy_type in POLICY_TYPES:
            ...
            print(f"  Best Storage NSE: {idx_best_storage} = {obj_df['Storage NSE'][idx_best_storage]}")
            print(f"  Best Average NSE: {idx_best_average} = {obj_df[['Release NSE','Storage NSE']].mean(axis=1)[idx_best_average]}")
